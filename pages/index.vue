<template>
	...
	<div class="grid grid-cols-12 h-[calc(100vh-64px)] justify-between">
		<div v-if="showToggleSwitches" class="flex absolute z-10 bottom-4 sm:bottom-8 left-1/2 -translate-x-1/2 lg:-translate-y-1/2 p-2 rounded-full bg-white space-x-2">
